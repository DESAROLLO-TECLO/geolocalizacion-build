package mx.com.teclo.alg.ws.persistencia.hibernate.dto.dispositivosmoviles;
...
@Entity
@Table(name = "TALG003C_TIPOS_DISPOSITIVOS")
public class DispositivoMovilTipoDTO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1485795387940985037L;
	...
	public String toString() {
		return "DispositivoMovilTipoDTO [idTipoDispositivo=" + idTipoDispositivo + ", cdTipoDispositivo="
				+ cdTipoDispositivo + ", nbTipoDispositivo=" + nbTipoDispositivo + ", activo=" + activo + ", creadoPor="
