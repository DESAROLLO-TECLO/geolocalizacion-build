...
public class EventoGpsVO {
	...
	public String toString() {
		return "EventoGpsVO [idEvento=" + idEvento + ", idEmpleado=" + idEmpleado + ", tipoEventoCodigo="
				+ tipoEventoCodigo + ", tipoEvento=" + tipoEvento + ", idArticulo=" + idArticulo + ", latitudGps="
				+ latitudGps + ", longitudGps=" + longitudGps + ", numSerieHH=" + numSerieHH + ", dispositivoMovil="
				+ dispositivoMovil + ", direccion=" + direccion + ", numInfraccion=" + numInfraccion
				+ ", fechaCreacion=" + fechaCreacion + ", fechaHoraEvento=" + fechaHoraEvento + "]";
	}
