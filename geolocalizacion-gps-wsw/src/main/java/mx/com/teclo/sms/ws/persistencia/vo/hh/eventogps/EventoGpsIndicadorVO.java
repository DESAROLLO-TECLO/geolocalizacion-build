...
public class EventoGpsIndicadorVO {
...
//	}
	...
	public String toString() {
		return "EventoGpsIndicadorVO [idEvento=" + idEvento + ", idEmpleado=" + idEmpleado + ", tipoEvento="
				...
				+ longitudGps + ", direccion=" + direccion + ", numInfraccion=" + numInfraccion + ", fechaCreacion="
				+ fechaCreacion + ", fechaHoraEvento=" + fechaHoraEvento + ", dispositivoMovil=" + dispositivoMovil
				+ ", indicador=" + indicador + "]";
	}
